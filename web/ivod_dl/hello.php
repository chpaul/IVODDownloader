...
<html lang="en">
  ...
  <body>
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="hello.php"><?php echo $webapp['name']; ?></a>
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="hello.php">START</a></li>
    ...
    <div class="container">
        ...
        <form name="input" action="hello.php?action=showinfo" method="POST">
        ...
        <div class="row">
            ...
            if($_GET['action'] == 'showinfo') {
				...
				echo '檔名將會是：'.$download_filename;
				echo '</pre>';				
				
				if($duration_sec > 0 ){
					echo '
					<form name="input" action="hello.php?action=download" method="POST">
					<div class="input-group">
        ...
        <div class="row">
            ...
            if($_GET['action'] == 'download') {
                ...
                $cmd_ivodurl_get ='php AdobeHDS.php --quality high --delete --useragent "'.$webapp['useragent'].'" --outfile "'.$filename.'" --manifest "'.$ivod_manifest_url.'"';
				$cmd_output = 'NULL';
				$cmd_return_var = 1;
