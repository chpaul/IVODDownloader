...
class iVodVideoDownload(QMainWindow):
    def __init__(self, argURLandFileNameList, argSaveFolder, argHD, argQTStatus):   
        ...
        self.Manifest = []
        self.header  ={'User-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.153 Safari/537.36'}
...
#    download = iVodVideoDownload(listURL, "D:\\1985\\python\\iVodDBUpdate",True,status)
